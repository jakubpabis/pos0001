...
const paths = {
  ...
  build: {
    base: {
      dir: "../build/wp-content/themes/postery",
    },
    css: {
      dir: "../build/wp-content/themes/postery/assets/css",
      files: "../build/wp-content/themes/postery/assets/css/**/*",
    },
    img: {
      dir: "../build/wp-content/themes/postery/assets/img",
      files: "../build/wp-content/themes/postery/assets/img/**/*",
    },
    js: {
      dir: "../build/wp-content/themes/postery/assets/js",
      files: "../build/wp-content/themes/postery/assets/js/**/*",
    },
    libs: {
      dir: "../build/wp-content/themes/postery/assets/libs",
    },
  },
  src: {
    base: {
...
gulp.task("watch", function () {
  gulp.watch(paths.src.scss.files, gulp.series("scss", "copy:allbuild"));
  gulp.watch(
...
gulp.task("copy:libsbuild", function () {
  return gulp
    .src(npmdist(), {
      base: paths.base.node.dir,
    })
    .pipe(gulp.dest(paths.build.libs.dir));
});

gulp.task("copy:allbuild", function () {
  console.log(paths.build.base.dir);
  return gulp
    .src([
      paths.src.js.dir,
      "!" + paths.src.js.files,
...
gulp.task("watchbuild", function () {
  gulp.watch(
    [paths.src.js.files, paths.src.img.files, paths.src.scss.files],
    gulp.series("scssbuild", "copy:allbuild", "copy:libsbuild")
  );
});
